...
const CoachCardNames: CoachCardNamesType = {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      <div className="flex w-full flex-col gap-4 sm:flex-row">
        ...
        <Select
          value={statusFilter}
          onValueChange={(value: 'active' | 'inactive') => setStatusFilter(value)}
        >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {['totalSessions', 'completed', 'upComing', 'players'].map((item) => (
                      <div
                        key={item}
                        className="bg-[#1A1A1A] border border-border space-y-1 px-4 py-2 rounded-lg"
                      >
                        <div className="text-muted-foreground items-center flex gap-2">
                          <CheckCircle size={16} />
                          <p className="text-sm">
                            {CoachCardNames[item as keyof CoachCardNamesType]}
                          </p>
                        </div>
                        ...
                        {Array.from({ length: 5 }).map((_, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className={cn(
                                index < rating ? 'bg-primary' : 'bg-[#3A3A3A]',
