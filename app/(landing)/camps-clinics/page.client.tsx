          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {camps
              .filter((item) => {
                ...
                return item.badge.toLowerCase().includes(filter.toLowerCase());
              })
                ...
                >
                  ...
                  <CardContent className="p-4 space-y-4">
                    ...
                    <Link href={`/camps-clinics/${item.id}`}>
                      <Button className="w-full bg-primary/20 text-primary hover:bg-primary/30 flex items-center gap-2">
                        View Details
