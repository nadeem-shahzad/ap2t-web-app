...
export const values = [
  {
    title: 'Excellence',
    description:
      'We pursue the highest standards in every training experience. We consistently refine our methods, inspire athletes to push their limits, and ensure every session delivers measurable progress.',
  },
  {
    title: 'Team Development',
    description:
      'We believe strong individuals build even stronger teams. Our programs focus on collaboration, leadership, and unity—helping players grow together on and off the field.',
  },
  {
    title: 'Goal-Oriented',
    description:
      'Every training session is designed with clear outcomes in mind. We set actionable targets, track performance, and help athletes stay focused on achieving real, impactful results. ',
  },
  {
    title: 'Professionalism',
    description:
      'We uphold integrity, discipline, and the highest coaching standards. From communication to conduct, we create an environment that reflects respect, responsibility, and top-tier soccer training practices.',
  },
];
...
export const detailIcons = [Calendar, Clock, Users, MapPin];
