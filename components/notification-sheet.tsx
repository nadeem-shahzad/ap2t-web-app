  ...
  return (
    <>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent className="bg-[#252525] border-[#3A3A3A] p-0 sm:max-w-[500px] gap-0">
          <SheetHeader className=" p-4">
            <div className="flex gap-4 items-center">
              <div
                className={`rounded-[8px] flex w-10 h-10 items-center justify-center bg-success-bg text-success-text`}
              >
                <Bell />
              </div>
        ...
        ${isRead ? 'bg-[#141414] border-[#2A2A2A] opacity-70' : 'bg-[#1A1A1A] border-[#3A3A3A]'} 
                    ...
                    <div className="flex gap-2">
                      <div className="space-y-1">
                        ...
                        <div className="flex gap-2 items-center">
                          <p className="text-xs text-muted-foreground">{item?.to_name}</p>
